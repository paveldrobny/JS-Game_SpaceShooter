...
export class Achievements {
  constructor() {
    ...
    this.data = [
      {
        title: localization.achievements[1],
        desc: localization.achievements[2],
        unlock:
          localStorage.getItem("a_fs") !== null
            ? localStorage.getItem("a_fs")
            : false,
      },
      {
        title: localization.achievements[3],
        desc: localization.achievements[4],
        unlock:
          localStorage.getItem("a_tk") !== null
            ? localStorage.getItem("a_tk")
            : false,
      },
    ];
  }
  ...
  UI() {
    if (this.isShowUI) {
      ...
      const textHeader = new Text(0, localization.achievements[0]);
